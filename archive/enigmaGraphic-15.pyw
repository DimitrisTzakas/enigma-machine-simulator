...
#------
#------place entries ----
textIn=Entry(frameOutText,font=("BOLD",16),bg='grey40',fg='black')
textIn.place(relx=0,rely=0,width=WIDTH,height=25)
textOut=Entry(frameOutText,font=("BOLD",16),bg='grey40',fg='yellow')
textOut.place(relx=0,rely=1,anchor=SW,width=WIDTH,height=25)
