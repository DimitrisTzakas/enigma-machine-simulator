...
#place variant
variantLabel=Label(frameSettings,text='Enigma-Wehrmacht',fg='silver',bg='grey22',font=("bold",11))
...
def placePlugboard():
    global lightKey
    plugKey=[None]*26
    plugBoard=Canvas(framePlugboard,width=WIDTH,height=100,bg='light slate gray',highlightthickness=0)
