...
def setRotorsSetting(rotor,s): # from left to right
    ...
    rotorsSetting[rotor]+=s
    rotorsSetting[rotor]=(rotorsSetting[rotor]-1) % 26 +1
    if rotorsSetting[rotor]==0: rotorsSetting[rotor]=26

def setRotorsRing(rotor,s): # from left to right
    global rotorsRing
    rotorsRing[rotor]+=s
    rotorsRing[rotor]=(rotorsRing[rotor]-1) % 26 +1
    if rotorsRing[rotor]==0: rotorsRing[rotor]=26
