...
frameSettings = Frame(root,width=WIDTH, height=150,bg="grey15")
frameSettings.grid(row=1,sticky='wen')
frameLightboard = Frame(root,width=500, height=180,bg='grey15')
frameLightboard.grid(row=2,sticky='wen')
frameKeyboard = Frame(root,width=WIDTH, height=180,bg="blue")
